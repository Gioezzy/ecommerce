<div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
    <section class="py-10 rounded-lg bg-gray-50 font-poppins dark:bg-grayRp. 500.000        <div class="px-4 py-4 mx-auto
        ...
        <div class="flex flex-wrap mb-24 -mx-3">
            <div class="w-full pr-2 lg:w-1/4 lg:block">
                <div class="p-4 mb-5 bg-white border border-gray-200 dark:border-gray-900 dark:bg-gray-900">
                    ...
                    <ul>
                        @foreach ($categories as $category)
                            <li class="mb-4" where:key="{{ $category->id }}">
                ...
                <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
                    ...
                    <div class="w-16 pb-2 mb-6 border-b border-rose-600 dark:border-gray-400"></div>
                    <div>
                        <div class="text-base font-semibold">{{ Number::currency($price_range, 'Rp.') }}</div>
                        <input type="range" wire:model.live='price_range'
                            class="w-full h-1 mb-4 bg-blue-100 rounded appearance-none cursor-pointer" max="30000000"
                            value="2000000" step="100000">
                        <div class="flex justify-between ">
                            <span
                                class="inline-block text-base font-bold text-blue-400 ">{{ Number::currency(1000000, 'Rp.') }}</span>
                            <span
                                class="inline-block text-base font-bold text-blue-400 ">{{ Number::currency(30000000, 'Rp.') }}</span>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="w-full px-3 mb-6 sm:w-1/2 md:w-1/3" wire:key="{{ $product->id }}">
                            <div class="border border-gray-300 dark:border-gray-700">
                                ...
                                <div class="p-3 ">
                                    ...
                                    <p class="text-lg ">
                                        <span
                                            class="text-green-600 dark:text-green-600">{{ Number::currency($product->price, 'Rp.') }}</span>
                                    </p>
                                </div>
